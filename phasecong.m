...
% imshow(totalEnergy), axis image, title('total energy');
% disp('Hit any key to continue '); pause
% imshow(totalSumAn), axis image, title('total sumAn'); 
% disp('Hit any key to continue '); pause
...
% imshow(phaseCongruency), axis image, title('phase congruency');
